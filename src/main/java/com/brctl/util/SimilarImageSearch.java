...
public class SimilarImageSearch {
	...
	public static String produceFingerPrint(InputStream inputStream) {
		//BufferedImage source = ImageHelper.readPNGImage(filename);// 读取文件
		BufferedImage source = ImageHelper.readPNGImage(inputStream);// 读取InputStream
